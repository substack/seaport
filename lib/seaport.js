...
Seaport.prototype.register = buffered(function (role, opts, cb) {
    ...
    if (!meta.port) {
        ...
        } while (this._usedPorts[meta.port]);
        
        this._usedPorts[meta.port] = true;
    }
...
Seaport.prototype.service = function () {
